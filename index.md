...
<div id="reloadsuggestion"><p id="reloadtext" style="opacity: 1; text-align: center;">Reload the page to revert the colors back to the original customized set.</p></div>
